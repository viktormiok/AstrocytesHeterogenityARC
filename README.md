...
### Overview
Because metabolic regulation by the central nervous system depends strongly on the coordinated activity of hypothalamic astrocytes and neurons, our observation that a hypercaloric diet triggers rapid, selective astrocytic remodeling well before measurable changes in body weight, inflammation, or insulin sensitivity stands out as particularly significant. To elucidate these early adaptations, we provide a comprehensive multi‑omics dataset capturing astrocytes and other cell types across multiple time points during the initial response to a high‑calorie diet. This resource offers deeper insight into the cellular circuits of the ARC and how they are reorganized in reaction to HFHS feeding. Our spatial point pattern analysis method advances cell analysis in various disciplines and experimental setups, helping to describe anatomy at a cellular level. 
