...
### Overview
Given that central nervous system–mediated metabolic regulation critically depends on the coordinated activity of hypothalamic astrocytes and neurons, the observation that a hypercaloric diet elicits rapid, selective astrocytic remodelling, preceding any measurable alterations in body weight, inflammation, or insulin sensitivity, is especially noteworthy. To elucidate these early adaptations, we provide a comprehensive multi‑omics dataset capturing astrocytes and other cell types across multiple time points during the initial response to a high‑calorie diet. This resource offers deeper insight into the cellular circuits of the ARC and how they are reorganized in reaction to HFHS feeding. Our spatial point-pattern analysis method advances cell analysis in various disciplines and experimental setups, helping to describe anatomy at a cellular level. 
